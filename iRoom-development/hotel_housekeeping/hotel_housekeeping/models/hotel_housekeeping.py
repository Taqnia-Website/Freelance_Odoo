...
class hotel_housekeeping(models.Model):
    ...
    current_date = fields.Datetime("Start Date", required=True, default=lambda *a: time.strftime('%Y-%m-%d %H:%M:%S'))
    end_date = fields.Datetime("Expected End Date", required=True)
