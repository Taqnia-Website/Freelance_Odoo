...
class product_category(models.Model):
    ...
    isparent = fields.Boolean('Is Parent',default = False)
    ...
    def create(self, vals):
        ...
        if self.env.context.get('isroomtype'):
            res.isroomtype = True
            res.isparent = True
...
class hotel_folio(models.Model):
    ...
    def action_confirm(self):
        for record in self:
            ...
            # if shop_id:
            #     record.order_id.write({'shop_id':shop_id.id})
