...
class MaintExcelExport(http.Controller):
    ...
    def maintenance_req_xlsx(self, req_id, **kw):
        ...
        ws.write(3, 0, 'تاريخ الطلب');ws.write(3, 1, str(req.date))
        ws.write(4, 0, 'اسم المركبة'); ws.write(4, 1, req.vehicle_name or '')
        ws.write(5, 0, 'نوع السيارة'); ws.write(5, 1, req.vehicle_type or '')
        ws.write(6, 0, 'اسم السائق');ws.write(6, 1, req.driver_name or '')
        row = 8
